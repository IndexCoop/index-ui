...
export const eth2xflexibleLeverageStrategyExtension =
  process.env.REACT_APP_ETH2X_FLEXIBLE_LEVERAGE_STRATEGY_EXTENSION
export const btc2xflexibleLeverageStrategyExtension =
  process.env.REACT_APP_BTC2X_FLEXIBLE_LEVERAGE_STRATEGY_EXTENSION
