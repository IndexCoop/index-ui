    ...
    <Page>
      ...
      <Container>
        <Card>
          <CardContent>
            <span>
              For more detailed information about the Index Coop, see the launch article <ExternalLink href="https://medium.com/@AnthonySassano/926169895488">here.</ExternalLink>
            </span>
          </CardContent>
        </Card>
        <Spacer />
        <Card>
          <CardContent>
            ...
            >
              ...
              <span>Instructions on how to get started mining INDEX can be found <ExternalLink href="https://medium.com/@AnthonySassano/926169895488">here</ExternalLink> under the liquidity mining section.</span>
            </Question>
          </CardContent>
        </Card>
      </Container>
