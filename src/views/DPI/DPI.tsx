...
import { Description, ProductDataUI } from 'components/ProductPage'
      ...
      <Description>
        ...
        <ul>
          ...
          <li>
            ...
            included in the index:Wrapped tokens. Tokenized derivatives.
            Synthetic assets. Tokens that are tied to physical assets. Tokens
            that represent claims on other tokens.
          </li>
        </ul>
        <h4>Token’s Supply Characteristics</h4>
        It must be possible to reasonably predict the token’s supply over the
        next five years. At least 7.5% of the five year supply must be currently
        circulating. The token’s economics must not have locking, minting or
        other patterns that would significantly disadvantage passive holders.
        <h4>Project’s Traction Characteristics</h4>
        <ul>
          <li>
            The project must be widely considered to be building a useful
            protocol or product.Projects focused on competitive trading/holding,
            having Ponzi characteristics, or projects that exist primarily for
        ...
        <ul>
          <li>
            ...
            assets safe under different circumstances.Alternatively, the
            protocol must have been operating long enough to create a consensus
            about its safety in the decentralized finance community.
          </li>
          <li>
            ...
            decentralized finance community with adequate documentation to
            provide transparency about the incident.
          </li>
          <li>
            The selected tokens must have sufficient liquidity across a variety
        ...
        <ul>
          <li>
            ...
            first circulating supply was determined on September 8, 2020, using
        ...
        It is the phase when the changes needed for the next reconstitution are
        determined.
        <ul>
          <li>
            <strong>Circulating Supply Determination:</strong> The DeFi Pulse
            Index currently references CoinGecko’s circulating supply number.
            The Circulating Supply is determined during the third week of the
            month and published before the monthly reconstitution.
          </li>
          <li>
          ...
          <li>
            ...
            25% during the determination phase will have its weight capped at
            25%. Any excess weight will be redistributed to the remaining
            components of the DeFi Pulse Index on a weighted basis. This same
            process will be repeated for every token exceeding the 25%
            allocation cap. reconstitution.
          </li>
        </ul>
        ...
        index weights, additions and deletions are incorporated into the index
        during the monthly reconstitution, which will take place on the first
        business day of the month. As assets tracked by the index grow, the
        reconstitution window will expand to more than one day to lower the
        reconstitution’s market impact.
      </Description>
    </ProductDataUI>
  )
}
