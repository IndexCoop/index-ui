        ...
        <ProductPageContent>
          ...
          <Description>
            <p>
              ...
              supply. The DeFi Pulse Index aims to track projects in
              ...
              characteristics. The inclusion criteria are the basis to select
              what tokens will be included in the index.
              ...
              <ul>
                ...
                <li>
                  The token must not be considered a security by the
                  corresponding authorities across different jurisdictions.
                </li>
                <li>
                  The token must be a bearer instrument. None of the following
                  will be included in the index:Wrapped tokens. Tokenized
                  derivatives. Synthetic assets. Tokens that are tied to
                  physical assets. Tokens that represent claims on other tokens.
                </li>
              </ul>
              ...
              currently circulating. The token’s economics must not have
              locking, minting or other patterns that would significantly
              disadvantage passive holders.
              ...
              <ul>
                <li>
                  ...
                  trading/holding, having Ponzi characteristics, or projects
                  that exist primarily for entertainment, will not be included.
                </li>
              ...
              <ul>
                <li>
                  ...
                  operating long enough to create a consensus about its safety
                  in the decentralized finance community.
                </li>
                <li>
                  In the event of a safety incident, the team must have
                  responded promptly and addressed the incident responsibly in
                  the aftermath, providing users of the protocol with a reliable
              ...
              <ul>
                <li>
                  ...
                  Pulse Index currently references CoinGecko’s circulating
                  supply number. The Circulating Supply is determined during the
                  third week of the month and published before the monthly
                  reconstitution.
                </li>
                <li>
                  <strong>Additions and deletions:</strong> The tokens being
                  added and deleted from the index calculation are determined
                  during the third week of the month and published before
                  monthly reconstitution.
                </li>
              </ul>
              <h4>Reconstitution Phase</h4>
              The index components are adjusted, added and deleted as per the
              instructions published after the end of the determination phase.
              New index weights, additions and deletions are incorporated into
              the index during the monthly reconstitution, which will take place
              on the first business day of the month. As assets tracked by the
              index grow, the reconstitution window will expand to more than one
              day to lower the reconstitution’s market impact.
            </p>
          </Description>
        </ProductPageContent>
      </Container>
