...
const DataProductPage = (props: { title: string }) => {
  ...
  return (
    <ProductDataUI tokenDataProps={tokenDataProps}>
      <p>
        <strong>The Data Economy Index (DATA)</strong> is designed to capture
        the trend of entertainment, sports and business shifting to take place
        in virtual environments.
        <h2>Constituent Weighting</h2>
        Selection of the $DATA tokens is based on the following basic criteria:
        <ul>
