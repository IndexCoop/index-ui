  ...
  return (
    <ProductDataUI tokenDataProps={tokenDataProps}>
      ...
      <p>
        ...
        banking and financial services, the Data Economy is disrupting the data
        monopolies built in Big Tech over the past 20 years.
      </p>
      ...
      <ul>
        <li>
          <strong>Data-based Protocol:</strong> The protocol provides data-based
        ...
        <li>
          <strong>Organic Network Activity or Usage:</strong> Protocol must have
          organic network activity or usage. On-chain transaction volume, Total
          Value Locked (TVL), and/or revenue paid to service providers are all
          examples of metrics that can be used to demonstrate organic network
          activity.
        </li>
        <li>
        ...
        <li>
          <strong>History:</strong> Protocol must have at least 3 months history
          of operation and its token must have at least 3 months of price and
          liquidity history.
        </li>
        <li>
        ...
        <li>
          ...
          methodologist will work with the project team to understand the issue
          and any effects to DATA holdings. The team is expected to provide
      ...
      <p>
        DATA will use circulating market capitalization to determine the weight
        of each token included in the index. The weight of each token within the
      ...
      <ul>
        <li>
          ...
          from the index calculation are determined during the final week of the
          quarter and published before quarterly rebalancing.
        </li>
        <li>
