...
import TotalSupplyContext from './IEth2xFLIPTokenSupplyCapContext'

const IEth2xFliTokenSupplyCapProvider: React.FC = ({ children }) => {
...
export default IEth2xFliTokenSupplyCapProvider
